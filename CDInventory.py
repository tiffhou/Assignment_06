...
# THou, 2020-Mar-02, added more formatting
#------------------------------------------#
...
class IO:
    ...
    @staticmethod
    def input_cd():
        """Gets the CD entry fields (ID, Title, Artist).
        ...
        """
        intID = DataProcessor.generate_ID()
        print('CD ID: ', intID)
...
try:
    ...
    print('CDInventory.txt loaded.')
    IO.show_inventory(lstTbl)
except FileNotFoundError:
    print('No save file available. Loading menu.\n')
    pass
